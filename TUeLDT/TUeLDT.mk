...
LinkOptions            :=  
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch). $(IncludeSwitch)../include $(IncludeSwitch)./include $(IncludeSwitch)../GeneratedFcns/include $(IncludeSwitch)../UnitTests $(IncludeSwitch)/usr/local/include/eigen3 
IncludePCH             := 
RcIncludePath          := 
Libs                   := 
ArLibs                 :=  
